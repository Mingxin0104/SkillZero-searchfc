...
SAVE_DIR="${SAVE_DIR:-/public/limingxin/SkillZero/checkpoints/searchqa_full_sft_full}"
...
bash "$REPO_ROOT/scripts/eval_searchqa_full_sft_mainppo.sh" "$LATEST_SFT_CKPT"
