...
TRAIN_DATA="${TRAIN_DATA:-$HOME/data/searchR1_processed_direct/searchqa_skill0_sft_full/train.parquet}"
VAL_DATA="${VAL_DATA:-$HOME/data/searchR1_processed_direct/searchqa_skill0_sft_full/val_1000.parquet}"
...
EXP_NAME="${EXP_NAME:-searchqa-full-sft-full}"
MICRO_BATCH_SIZE_PER_GPU="${MICRO_BATCH_SIZE_PER_GPU:-21}"
TRAIN_BATCH_SIZE="${TRAIN_BATCH_SIZE:-420}"
