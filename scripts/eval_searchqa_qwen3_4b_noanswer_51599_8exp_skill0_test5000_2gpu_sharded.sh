...
LOG_DIR="${LOG_DIR:-/workspace/limingxin/logs/searchqa_qwen3_4b_noanswer_51599_8exp_skill0_eval_5000_2gpu_sharded}"
...
RAY_TMP_ROOT="${RAY_TMP_ROOT:-/workspace/limingxin/rt/q5000}"

mkdir -p "$MERGED_ROOT" "$LOG_DIR" "$RAY_TMP_ROOT"

RUN_SPECS=(
  "qwen3_4b_base_test5000|base|$BASE_MODEL"
  "qwen3_4b_noanswer_51599_with_skill_lora_r8_ep1_test5000|adapter|qwen3_4b_noanswer_51599_with_skill_lora_r8_ep1"
  "qwen3_4b_noanswer_51599_no_skill_lora_r8_ep1_test5000|adapter|qwen3_4b_noanswer_51599_no_skill_lora_r8_ep1"
  "qwen3_4b_noanswer_51599_with_skill_lora_r16_ep1_test5000|adapter|qwen3_4b_noanswer_51599_with_skill_lora_r16_ep1"
  "qwen3_4b_noanswer_51599_no_skill_lora_r16_ep1_test5000|adapter|qwen3_4b_noanswer_51599_no_skill_lora_r16_ep1"
  "qwen3_4b_noanswer_51599_with_skill_lora_r32_ep1_test5000|adapter|qwen3_4b_noanswer_51599_with_skill_lora_r32_ep1"
  "qwen3_4b_noanswer_51599_no_skill_lora_r32_ep1_test5000|adapter|qwen3_4b_noanswer_51599_no_skill_lora_r32_ep1"
  "qwen3_4b_noanswer_51599_with_skill_lora_r64_ep1_test5000|adapter|qwen3_4b_noanswer_51599_with_skill_lora_r64_ep1"
  "qwen3_4b_noanswer_51599_no_skill_lora_r64_ep1_test5000|adapter|qwen3_4b_noanswer_51599_no_skill_lora_r64_ep1"
)
...
eval_one() {
    ...
    local search_url="$4"
    local short_name
    short_name="$(printf '%s' "$run_name" | sed 's/qwen3_4b_//g; s/_test5000//g; s/_with_skill/ws/g; s/_no_skill/ns/g; s/_noanswer_//g; s/_51599//g; s/_lora_r/r/g; s/_ep1//g; s/base/b/g')"
    local short_tmp
...
log "SearchQA qwen3-4b noanswer 51599 test5000 2gpu sharded eval started"
...
log "All SearchQA qwen3-4b noanswer 51599 test5000 2gpu sharded evals finished"
