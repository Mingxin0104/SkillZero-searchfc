...
if not hasattr(PreTrainedTokenizerBase, "all_special_tokens_extended"):
    ...
    def all_special_tokens_extended(self):
        additional_tokens = getattr(self, "additional_special_tokens", None) or []
        return list(self.all_special_tokens) + list(additional_tokens)
...
class vLLMRollout(BaseRollout):
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        qwen35_text_base = os.environ.get("QWEN35_TEXT_BASE_MODEL", "/workspace/limingxin/models/Qwen3.5-4B-text")
        if getattr(model_hf_config, "model_type", None) == "qwen3_5_text":
            llm_kwargs["hf_config_path"] = qwen35_text_base
            llm_kwargs["language_model_only"] = True
            llm_kwargs["attention_config"] = {"backend": "TRITON_ATTN"}
